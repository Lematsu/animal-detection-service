...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    # Print overall counts and percents
    print('** Printing Results for model architecture {0} **'.format(model))
    print('N Images: {0}  N Dog Images: {1}  N NOTDog Images: {2}'.format(results_stats_dic['n_images'],
                                                                          results_stats_dic['n_dogs_img'],
                                                                          results_stats_dic['n_notdogs_img']))
    print('Pct Corr dog: {1}  Pct corr NOTdog: {1}  Pct Corr Breed: {2}  Pct Match: {3}'.format(
